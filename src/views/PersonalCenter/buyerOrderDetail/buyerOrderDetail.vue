                    ...
                    <ul>
                        ...
                        <li>
                             ...
                             <div class="center">
                                 ...
                                 <p v-if="item.orderVo.firtPayNo && item.orderVo.firtPayNo==item.orderVo.lastPayNo">
                                    <strong>付款编号:</strong>
                                    {{item.orderVo.firtPayNo}}
                                    <span>{{payTypeMark[item.orderVo.prePayChannel].title}}</span>
                                </p>
                                <p v-if="item.orderVo.firtPayNo && item.orderVo.firtPayNo!=item.orderVo.lastPayNo">
                                ...
                                <p v-if="item.orderVo.lastPayNo && item.orderVo.firtPayNo!=item.orderVo.lastPayNo">
                ...
                <div class="list clear">
                    ...
                    <div class="fr total">
                        <p class=""><strong class="">人民币</strong>共{{countObj.renCount}}种器件，金额小计：<span class="right">{{countObj.ren | toFixed(2)}}</span></p>
                         ...
                         <P>今日美元汇率牌价：<span class="right">{{item.orderVo.fin_exchange}}</span></P>
                         <P>海关增值税13%：<span class="right">{{item.orderVo.order_bill}}</span></P>
                     ...
                     <div class="footer">应付人民币总额：<label>￥{{item.orderVo.order_amount | toFixed(2)}}</label></div>
                </div>
            </div>
