  ...
  <div class="sellerFeed">
    ...
    <div class="feed">
      <el-table :data="list" border style="width: 100%">
        <el-table-column prop="title" label="反馈类型" align="center"></el-table-column>
        <el-table-column prop="content" label="反馈内容"  align="center"></el-table-column>
        <el-table-column prop label="附件内容"  align="center">
             <template slot-scope="scoped" v-if="scoped.row.url">
                <span v-for="item in scoped.row.url.split('@')" :key='item'>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      axios.request({ ...common.queryFeedList, params: obj }).then(res => {
        console.log(res);
        this.list = res.data;
