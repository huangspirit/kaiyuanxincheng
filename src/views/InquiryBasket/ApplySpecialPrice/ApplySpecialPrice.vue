      ...
      <div class="special-price">
        <div class="product-msg">
          ...
          <div class="product-msg-text">
            <p class="name">CDHDFJHKS-234J</p>
            <P>
              <label>品牌：</label>
              罗彻斯特电子 (RE)
            </P>
            <p class="xh" title="The 7721-7PPSG is an Insulating Shoulder Washer made of 40% glass filled polyphenylene sulfide (PPS) body. Its recommended torque is 0.565 to 0.678Nm (5 to 6-inch-lbs) on shoulder washer.">
              <label>型号描述：</label>
              The 7721-7PPSG is an Insulating Shoulder Washer made of 40% glass filled polyphenylene sulfide (PPS) body. Its recommended torque is 0.565 to 0.678Nm (5 to 6-inch-lbs) on shoulder washer.
            </p>
            <p>
              共有
              <span class="num">3</span>
              个供应商报价
              <span class="num">￥2.5——￥4.0</span>
              公司名称：北京聚多才科技有限公司
            </p>
          </div>
          <LadderPrice :borderColor="'bd-b'">原厂报价</LadderPrice>
        </div>
        <div class="brans-msg">
      ...
      <div class="apply-inform">
        ...
        <div class="form">
          ...
          <div class="acceptPrice">
            ...
            <el-select v-model="form.priceType" slot="append" placeholder="请选择" @change="selectChange">
