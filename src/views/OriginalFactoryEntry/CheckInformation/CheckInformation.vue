    ...
    <div class="CheckInformation allWidth">
      <div class="CheckInformation-con">
        ...
        <!-- <div style="text-align:center;">
          <el-checkbox v-model="hasReading" style="margin-right:2px;">我已阅读并接受</el-checkbox>《
          <strong @click="showXieyi=true">{{title}}供应商申请入驻协议</strong>》
        </div> -->
