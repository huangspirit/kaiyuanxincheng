        ...
        >
          ...
          <el-form-item label="营业期限：" prop="businesshoursstart" >
            ...
            <el-date-picker
              ...
              placeholder="营业结束日期"
            ></el-date-picker>
            <!-- <el-checkbox v-model="checkboxChangeValue2" class="longTime">长期</el-checkbox> -->
            ...
            <div class="form-item-con">
              <el-form-item label="有效期：" prop="businesslicensestarttime">
                ...
                <el-date-picker
                  ...
                  format="yyyy/MM/dd"
                ></el-date-picker>
                <!-- <el-checkbox v-model="checkboxChangeValue" class="longTime">长期</el-checkbox> -->
                <!-- <span class="long-time">
                  <label class="label">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        companydetailaddress:[ { required: true, message: "请选择公司注册地址", trigger: "blur" }],
        enterprisephone: [
          {
            required: true,
            message: "请输入企业负责人手机号",
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.AgentList.forEach((item, index) => {
            console.log(item)
            this.ruleForm.qualificationtime[index] = item.qualificationstarttime+'-'+item.qualificationendtime;
          });
