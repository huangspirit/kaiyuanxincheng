<template>
  <div class="Countdown">
    <p v-if="msTime.show">
      ...
      <span v-if="msTime.day>0" class="text">{{msTime.day}}</span>
      <i v-if="msTime.day>0">{{dayTxt}}</i>
      <span class="text">{{msTime.hour}}</span>
      <i>{{hourTxt}}</i>
      <span class="text">{{msTime.minutes}}</span>
      <i>{{minutesTxt}}</i>
      <span class="text">{{msTime.seconds}}</span>
      <i>{{secondsTxt}}</i>
    </p>
