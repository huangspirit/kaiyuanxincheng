...
<div>
    ...
    <div class="wrap">
        ...
        <div class="kuang">当前应付金额为：<p style="font-size:20px;margin-top:10px;"><strong>￥{{bankTransferObj.money | toFixed(2)}}</strong></p></div>
        <div>您的专属收款账号如下：</div>
        <div class="kuang">
            <p>公司名称：北京晶圆电子有限公司</p>
        ...
        <div class="desc color" v-if="bankTransferObj.time">重点提示：请务必于{{bankTransferObj.time | formatDate}}前完成汇款，否则将视为自动放弃当前订单！</div>
         <el-form  label-width="120px"  :rules="rules" ref="ruleForm" :model="ruleForm" >
                      ...
                      <el-form-item label="开户行：" prop="customerBank">
                          <el-input v-model="ruleForm.customerBank"></el-input>
                      </el-form-item>
                      <el-form-item label="转账金额：" prop="transMoney">
                          <el-input v-model="ruleForm.transMoney"></el-input>
                           <div class="desc color" v-if="ruleForm.transMoney && ruleForm.transMoney!=bankTransferObj.money" style="text-align:left;">您输入的转账金额和应付金额不相等</div>
                      </el-form-item>
