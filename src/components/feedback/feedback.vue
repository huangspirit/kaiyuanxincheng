...
.<template>
  <div>
    ...
    <el-dialog :visible.sync="show" width="700px" :append-to-body="true" :center="true" top="5vh">
      <h2 slot="title" class="dialog-title">问题反馈</h2>
      <div class="cont">
        <div class="tit">
        ...
        <el-form :model="form" class="el-form" >
          ...
          <el-form-item label="详细描述：">
            <el-input type="textarea" v-model="form.content" :rows="3" placeholder="请尽可能的描述清楚您的疑问"  style="width:auto;min-width:400px"></el-input>
          </el-form-item>
          ...
          <el-form-item label style="text-align:center;">
            <el-button class="bgColor" @click="onSubmit" type="primary">提交反馈</el-button>
          </el-form-item>
        </el-form>
      </div>
...
export default {
  ...
  methods: {
    ...mapActions("Common", ["GetQueryItem","saveFeed"]),
    onSubmit() {
